...
import com.dockit.deskclock.Alarms;
import com.dockit.deskclock.R;
import com.dockit.deskclock.Utils;
import com.dockit.deskclock.worldclock.CityObj;
...
public class DigitalWidgetViewsFactory extends BroadcastReceiver implements RemoteViewsFactory {
    ...
    public void onCreate() {
        ...
        filter.addAction("com.dockit.deskclock.NEXT_ALARM_TIME_SET");
        filter.addAction("com.dockit.deskclock.worldclock.update");
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (action.equals("com.dockit.deskclock.NEXT_ALARM_TIME_SET")) {
        ...
        } else if (action.equals("com.dockit.deskclock.worldclock.update")) {
